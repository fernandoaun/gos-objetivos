...
from gos.modulos.objetivos.models import Area, Responsable
from gos.modulos.objetivos.models.foda import FODA_LABELS, FODA_TIPOS
from gos.modulos.objetivos.services import foda_service
...
bp = Blueprint("objetivos_foda", __name__)
