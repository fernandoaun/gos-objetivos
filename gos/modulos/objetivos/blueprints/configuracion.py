...
bp = Blueprint("objetivos_configuracion", __name__)
...
def crear_sector():
    ...
    if not codigo or not nombre:
        ...
        return redirect(url_for("objetivos_configuracion.index", tab="sectores"))
...
def crear_area():
    ...
    if not codigo or not nombre:
        flash("Código y nombre son obligatorios.", "warning")
        return redirect(url_for("objetivos_configuracion.index", tab="areas"))
    db.session.add(
        Area(
...
def crear_responsable():
    ...
    if not codigo or not nombre:
        flash("Código y nombre son obligatorios.", "warning")
        return redirect(url_for("objetivos_configuracion.index", tab="responsables"))
    db.session.add(
        Responsable(
            empresa_id=_empresa_id(),
            codigo=codigo,
...
def guardar_umbrales():
    ...
    return redirect(url_for("objetivos_configuracion.index", tab="umbrales"))
