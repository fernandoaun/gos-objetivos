...
def _register_blueprints(app: Flask, url_prefix: str) -> None:
    from gos.modulos.dashboard.blueprints.api import bp as api_bp
    from gos.modulos.dashboard.blueprints.main import bp as main_bp
...
def module_descriptor() -> dict:
    return {
        "code": MODULE_NAME,
        "label": "DashBoard",
        "description": "Vista holográfica unificada de todos los módulos GOS.",
        "icon": "bi-hdd-stack",
        "url": "/gos/dashboard/",
    }
