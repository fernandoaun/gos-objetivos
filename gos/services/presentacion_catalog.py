...
CATALOG: dict[str, dict] = {
    ...
    "capacitacion": _mod(
        ...
        pilares=["Programas · Matriz · Evidencias · Cumplimiento"],
        ...
        submodulos=[
            ...
            },
            {
                ...
                "label": "Programas",
                "eyebrow": "EJECUCIÓN",
                "title": "Los programas agrupan planes, cursos y puestos",
            ...
            },
            {
                ...
                "bullets": [
                    ...
                    "Resumen el estado general del programa formativo.",
