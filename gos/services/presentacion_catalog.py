...
CATALOG: dict[str, dict] = {
    ...
    "capacitacion": _mod(
        ...
        pilares=["Puestos · Planes de carrera · Matriz · Cumplimiento"],
        ...
        statement_pilares=["Puesto · Plan de carrera · Evidencia · Alertas"],
        proceso=["PLANIFICAR", "DICTAR", "REGISTRAR", "ACREDITAR", "ALERTAR", "MEJORAR"],
        flujo=[
            {"title": "PUESTOS", "subtitle": "personas y requisitos"},
            {"title": "PLANES DE CARRERA", "subtitle": "planes y cursos"},
        ...
        submodulos=[
            ...
            },
            {
                ...
                "eyebrow": "EJECUCIÓN",
                "title": "Los planes de carrera cuelgan del puesto",
                "highlight": "cuelgan del puesto",
                "bullets": [
                    "Primero el puesto, después el plan de carrera y luego los planes con cursos.",
                    "Las personas heredan el seguimiento de carrera de su puesto.",
