...
class Empresa(db.Model, TimestampMixin):
    ...
    sectores = db.relationship("Sector", back_populates="empresa", lazy="dynamic")
    areas = db.relationship("Area", back_populates="empresa", lazy="dynamic")
    responsables = db.relationship("Responsable", back_populates="empresa", lazy="dynamic")
    usuarios = db.relationship("Usuario", back_populates="empresa", lazy="dynamic")
    config = db.relationship("PlaneamientoConfig", back_populates="empresa", uselist=False)
...
class Sector(db.Model, TimestampMixin):
    ...
    empresa = db.relationship("Empresa", back_populates="sectores")
...
class Responsable(db.Model, TimestampMixin):
    ...
    empresa = db.relationship("Empresa", back_populates="responsables")
